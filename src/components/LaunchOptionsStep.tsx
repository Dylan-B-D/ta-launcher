...
const LaunchOptions = () => {
  ...
  const [customDLLPath, setCustomDLLPath] = useState(
    config.customDLLPath || ""
  );
  ...
  useEffect(() => {
    ...
    if (
      config.dllVersion !== "None" &&
      config.dllVersion !== "Custom" &&
      !completedPackages.has(currentPackageId)
    ) {
  ...
  return (
    <>
      ...
      <SegmentedControl
        ...
        onChange={(value) =>
          setConfig((prev: any) => ({ ...prev, launchMethod: value }))
        }
      ...
      <Text size="sm" c="dimmed">
        <strong>PUG:</strong> PUG login server hosted by Dodge, used for
        organized and competitive play with custom rulesets.
      </Text>
      <Text size="sm" c="dimmed">
        ...
        {config.loginServer === "Custom" && (
          <div style={{ display: "flex", alignItems: "center" }}>
            <TextInput
              ...
              onChange={(event) =>
                handleCustomIPChange(event.currentTarget.value)
              }
      ...
      >
        ...
        <Text size="sm" c="dimmed">
          <strong>Recommended:</strong> Release
        </Text>
      </div>
      <Text size="sm" c="dimmed">
      ...
      <Text size="sm" c="dimmed">
        <strong>Note:</strong> Other versions are primarily used for testing
        purposes.
      </Text>
          ...
          <>
            <TextInput
              ...
              onChange={(e) => {
                ...
                setConfig((prev) => ({
                  ...prev,
                  customDLLPath: e.currentTarget.value,
                }));
              }}
      ...
      >
        <Text size="sm">
          The selected DLL version is not downloaded. Would you like to add it
