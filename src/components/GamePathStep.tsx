      ...
      >
        <Paper shadow="xs" p="md" style={{ width: "100%" }}>
          <Text size="sm" c="dimmed">
            A Tribes: Ascend installation is required. (
            <strong>Recommended:</strong> Steam version)
          </Text>
          <Space h="md" />
          <div
      ...
      <Container>
        <Paper shadow="xs" p="md" style={{ width: "100%" }}>
          <Text ta="center" size="sm" c="dimmed">
            If the path to the TribesAscend.exe executable is not detected, you
            can manually add it.
          </Text>
          <Text ta="center" size="sm" c="dimmed">
            The executable is usually located in:
            '..\Tribes\Binaries\Win32\TribesAscend.exe'
          </Text>
          <Space h="lg" />
          ...
          >
            ...
            <Button
              color="cyan"
              variant="light"
              onClick={() => findGamePath(setConfig)}
              style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.25)" }}
            >
