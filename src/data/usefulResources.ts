...
export const discordResources: Resource[] = [
  {
    ...
    description:
      "Active North American Discord Server, used for Mixers and PUGs.",
  ...
  },
  {
    ...
    description:
      "Griffon's Discord, used for the community login server, and server hosting.",
...
export const usefulResources: Resource[] = [
  {
    ...
    description:
      "Additional information on game setup, and resources for community map development.",
  ...
  },
  {
    title: "TAMods",
    description:
      "Info about TAMods, and guides on writing hud modules and scripts.",
